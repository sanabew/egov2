...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        personData.add(new Person("med", "haj"));
        personData.add(new Person("monta", "behi"));
        personData.add(new Person("marwa", "henchir"));
    ...
    public void CreateNewChild() {
		...
		try {
			FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("view/ValidateNewChild.fxml"));
			AnchorPane page = (AnchorPane) loader.load();
			Scene scene = new Scene(page);
			primaryStage.setScene(scene);
			primaryStage.show();
